class Public::PostShogiPlacesController < ApplicationController
  ...
  def post_shogi_place_params
    params.require(:post_shogi_place).permit(:customer_id,:prefecture_id,:name,:address,:latitude,:longiture,:telephone_number,:explanation,:shogi_place_image,:tag_name,tags_attributes: [:name],target_audience_ids: [])
  end
